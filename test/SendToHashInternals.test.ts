...
import { MockToken, SendToHashMock, SendToHashMockData, MockNFT, MaticPriceAggregatorV3Mock, IDriss, MockERC1155 } from '../src/types'
...
describe('SendToHashMock contract internals', async () => {
   ...
   describe('Common - lightweight', async () => {
      before(async () => {
         await setupSendToAnyone()
         await setupERC1155()
         await setupERC20()
